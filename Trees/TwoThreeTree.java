...
public class TwoThreeTree {
    ...
    private class TreeNode extends Node {
        ...
        TreeNode() {
            ...
            keys = new Bin[2];          // keys[0] = min key in middle subtree
        ...
        void print() {
            ...
            if (degree == 1) {
                ...
                System.out.print("(" + keys[0].remainingCapacity + ",-) ");
            } else {
                System.out.print("(" + keys[0].remainingCapacity + "," + keys[1].remainingCapacity + ") ");
            }
        } // print() ends here
    } // TreeNode ends here
    ...
    private Node[] insert(int key, Node n) {
        ...
        // stores references to TreeNodes
            ...
            if (key < t.keys[0].getRemainingCapacity()) {
            ...
            // or second is null
            else if (key >= t.keys[0].getRemainingCapacity() && (t.children[2] == null || key < t.keys[1].getRemainingCapacity())) {
            ...
            else if (key >= t.keys[1].getRemainingCapacity()) {
        ...
        // stores references to LeafNodes
            ...
            if (t.degree <= 2) {
                ...
                if (t.degree == 1 && key > l1.bin.getRemainingCapacity()) {
                    LeafNode leaf = new LeafNode();
                    t.children[1] = leaf;
                } else if (t.degree == 1 && key < l1.bin.getRemainingCapacity()) {
                    LeafNode leaf = new LeafNode();
                    t.children[1] = l1;
                    t.children[0] = leaf;
                } else if (t.degree == 2 && key < l1.bin.getRemainingCapacity()) {
                    LeafNode leaf = new LeafNode();
                    t.children[2] = l2;
                    t.children[1] = l1;
                    t.children[0] = leaf;
                } else if (t.degree == 2 && key < l2.bin.getRemainingCapacity() && key > l1.bin.getRemainingCapacity()) {
                    LeafNode leaf = new LeafNode();
                    t.children[2] = l2;
                    t.children[1] = leaf;
                } else if (t.degree == 2) {
                ...
                if (key < l1.bin.getRemainingCapacity()) {
                    ...
                    array[0] = t;
                    array[1] = newNode;
                } else if (key >= l1.bin.getRemainingCapacity() && key < l2.bin.getRemainingCapacity()) {
                    ...
                    array[0] = t;
                    array[1] = newNode;
                } else if (key >= l2.bin.getRemainingCapacity() && key < l3.bin.getRemainingCapacity()) {
                    ...
                    array[0] = t;
                    array[1] = newNode;
                } else if (key >= l3.bin.getRemainingCapacity()) {
        ...
        if (t != null && t.children[0] instanceof TreeNode) {
            ...
            if (t.degree == 3) {
                ...
                if (key == l1.bin.getRemainingCapacity()) {
                    ...
                    t.children[1] = l3;
                    t.children[2] = null;
                } else if (key == l2.bin.getRemainingCapacity()) {
                    t.children[1] = l3;
                    t.children[2] = null;
                } else if (key == l3.bin.getRemainingCapacity()) {
                    t.children[2] = null;
                ...
                if (l1.bin.remainingCapacity == key) {
                    t.children[0] = l2;
                    t.children[1] = null;
                } else if (l2.bin.remainingCapacity == key) {
                    t.children[1] = null;
                }
    ...
    private boolean search(int key, Node n) {
        ...
        if (t != null) {
            ...
            else if (t.degree == 2 && key < t.keys[0].remainingCapacity) {
                // Continue search in left node
                found = search(key, t.children[0]);
            ...
            else if (t.degree == 3 && key < t.keys[0].remainingCapacity) {
                // Continue search in left node
                found = search(key, t.children[0]);
            } // If it has a degree of 3 and the value to be searched for is in between 1st and 2nd key
            else if (t.degree == 3 && key >= t.keys[0].remainingCapacity && key < t.keys[1].remainingCapacity) {
                // Continue search in middle node
                found = search(key, t.children[1]);
            } // If it has a degree of 3 and the value to be searched for is greater than 2nd key
            else if (t.degree == 3 && key >= t.keys[1].remainingCapacity) {
        ...
        else if (l != null && key == l.bin.remainingCapacity) {
            return true;
        } // outer if else ends here
    ...
    private void keyOrderList(Node n) {
        ...
        if (t != null) {
            ...
            System.out.print(l.bin.remainingCapacity + " ");
        } // outer if else ends here
    ...
    //     if (root.keys[0] != null) {
    //         root.keys[0].remainingCapacity -= 5;
    //     }
    //     updateTree(root);
    // }
