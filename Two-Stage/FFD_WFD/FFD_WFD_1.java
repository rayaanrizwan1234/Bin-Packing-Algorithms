...
public class FFD_WFD_1 {
    ...
    // This method is used to set triggers for number of bins
    boolean ffdToWfd(Integer items[], int capacity, double binRatio) {
        ...
        try {
            ...
            try (Scanner textReader = new Scanner(binText)) {
                ...
                for (int i = 0; i < problems; i++) {
                    ...
                    // Testing objects
                    FFD_WFD_1 hybrid = new FFD_WFD_1();
                    hybrid.ffdToWfd(item, capacity, 0.9);
