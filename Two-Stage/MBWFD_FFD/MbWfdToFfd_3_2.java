...
public class MbWfdToFfd_3_2 {
    ...
    void hybridMbWfdToFfd(Integer[] items, int capacity, double capacityRatio, double itemRatio, double binRatio) {
        ...
        try {
            ...
            try (Scanner textReader = new Scanner(binText)) {
                ...
                for (int i = 0; i < problems; i++) {
                    ...
                    res.hybridMbWfdToFfd(item, capacity, 0.51, 0.7, 0.95);
