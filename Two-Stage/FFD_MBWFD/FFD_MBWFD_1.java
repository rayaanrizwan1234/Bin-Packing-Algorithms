...
public class FFD_MBWFD_1 {
    ...
    boolean ffdToMbWfd(Integer items[], int capacity, double binRatio) {
        ...
        try {
            ...
            for (Double binRatio = 0.0; binRatio <= 1; binRatio += 0.01) {
                ...
                try (Scanner textReader = new Scanner(binText)) {
                    ...
                    for (int i = 0; i < problems; i++) {
                        ...
                        // Testing objects
                        FFD_MBWFD_1 res = new FFD_MBWFD_1();
                        res.ffdToMbWfd(item, capacity, binRatio);
                        sum += res.numOfBins;
                    }
            ...
            try (Scanner textReader = new Scanner(binText)) {
                ...
                for (int i = 0; i < problems; i++) {
                    ...
                    // Testing objects
                    FFD_MBWFD_1 res = new FFD_MBWFD_1();
                    res.ffdToMbWfd(item, capacity, rat);
